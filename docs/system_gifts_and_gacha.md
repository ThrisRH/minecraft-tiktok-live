...
| **Lucky Pig** | Summon Entity | Triệu hồi ngẫu nhiên 3 lính Recruits (`villager_noble` hoặc `bowman`) trang bị full giáp sắt, vũ khí & tăng tốc độ di chuyển (speed 0.5), phí thuê 0 (gắn tên người donate) |
