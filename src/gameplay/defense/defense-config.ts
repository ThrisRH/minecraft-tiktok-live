...
export const defenseGiftMap: Record<string, string> = {
  ...
  Creeper: "creeperGift",
  TikTok: "tiktokGift",
  Overreact: "overreactGift",
  Perfume: "perfumeGift",
  Rosa: "perfumeGift",
  GG: "ggGift",
  Heart: "fingerHeartGift",
  "Finger Heart": "fingerHeartGift",
  "Journey Pass": "journeyPassGift",
  "Little Kisses": "littleKissesGift",
  Kisses: "littleKissesGift",
  Okay: "okayGift",
  Doughnut: "doughnutGift",
