...
const GIFT_CATALOG: GiftMetadata[] = [
  ...
  },
  {
    ...
    category: "gacha",
    description: "Vòng quay Gacha triệu hồi Quái vật Đột Biến (Mutant Mobs)",
  ...
  },
  {
    id: "Confetti",
    name: "Confetti",
    titleVi: "Pháo Hoa Rồng",
    category: "mob",
    description: "Triệu hồi 1 Rồng Huyền Thoại Ender Dragon pháo hoa",
    effectVi: "🐲 Rồng Ender Dragon",
    icon: "🎉",
  },
  {
    id: "Lucky Pig",
    ...
    titleVi: "Heo May Mắn",
    category: "mob",
    description: "Triệu hồi 3 Vệ Binh Bodyguard (Giáp ngực sắt Bảo vệ II, Kiếm đá)",
    effectVi: "🛡️ 3x Bodyguard",
    icon: "🐷",
  },
  {
    id: "Finger Heart",
  ...
  },
  {
    ...
    category: "item",
    description: "Cho 1 Táo Vàng Phù Phép + Áo Sắt (Protection IV, Blast Prot III)",
    effectVi: "✨ Táo Phù Phép & Áo Sắt",
    icon: "💋",
  },
  {
    id: "Perfume",
